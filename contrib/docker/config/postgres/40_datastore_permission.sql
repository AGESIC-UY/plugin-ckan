...
-- the datastore DB:
\connect "datastore_prod"

-- revoke permissions for the read-only user
REVOKE CREATE ON SCHEMA public FROM PUBLIC;
REVOKE USAGE ON SCHEMA public FROM PUBLIC;

GRANT CREATE ON SCHEMA public TO "ckan_prod";
GRANT USAGE ON SCHEMA public TO "ckan_prod";

GRANT CREATE ON SCHEMA public TO "ckan_prod";
GRANT USAGE ON SCHEMA public TO "ckan_prod";

-- take connect permissions from main db
REVOKE CONNECT ON DATABASE "ckan_prod" FROM "datastore_ro";

-- grant select permissions for read-only user
GRANT CONNECT ON DATABASE "datastore_prod" TO "datastore_ro";
...
ALTER DEFAULT PRIVILEGES FOR USER "ckan_prod" IN SCHEMA public
...
ALTER VIEW "_table_metadata" OWNER TO "ckan_prod";
...
ALTER FUNCTION populate_full_text_trigger() OWNER TO "ckan_prod";
