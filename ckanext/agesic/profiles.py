...
from ckanext.agesic.commands import (get_update_frequency_text)
...
class AgesicDCATAPProfile(RDFProfile):
    ...
    def graph_from_dataset(self, dataset_dict, dataset_ref):
        ...
        for resource_dict in dataset_dict.get('resources', []):
            ...
            # Frequency
            upd_frequency = resource_dict.get('update_frequency')
            if upd_frequency:
                update_frequency_value = get_update_frequency_text(upd_frequency)
                g.add((
                    distribution,
                    DCT.Frequency,
                    Literal(update_frequency_value)))
